...
<%--     <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_BTE_YWZX_KLW>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block;   top: 88px; left: 300px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px; bottom: 512px;"></div>--%>
        <%--银川公司兰山分厂--%>
...
<%--     <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_BTE_YWZX_KLW>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block; top: 113px; left: 300px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;   top: 88px;"></div>--%>
...
<%--        <div class="AnlogSignal mchart" id="zc_nxjc_znc_znf>dcs02_EHO>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block; top: 381px; left: 900px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px; bottom: 244px;"></div>--%>
        <%--六盘水公司--%>
          <div class="AnlogSignal mchart" id="zc_nxjc_lpsc_lpsf>dcs01_YCZS>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 85px; display: block; left: 278px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;    top: 292px;"></div>
           <div class="AnlogSignal mchart" id="zc_nxjc_lpsc_lpsf>dcs01_SO2ZS>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block;left: 385px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;    top: 292px;"></div>

          <div class="AnlogSignal mchart" id="zc_nxjc_lpsc_lpsf>dcs01_NOZS>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 94px; display: block;left: 457px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;     top: 292px;"></div>
          <div class="AnlogSignal mchart" id="zc_nxjc_lpsc_lpsf>dcs01_O2>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 55px; display: block;left: 559px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;     top: 292px;"></div>
          <div class="AnlogSignal mchart" id="zc_nxjc_lpsc_lpsf>dcs01_HBLL>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 41px; display: block;left: 619px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;     top: 292px;"></div>
        <%--天水公司--%>
        ...
        <%--乌海赛马--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_F_33301_KL_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; left: 263px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;   top: 320px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_F_33301_FC_R1>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; left: 325px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;   top: 320px;"></div>
         <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_F_33301_SO_R1>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block; left: 385px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;   top: 320px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_F_33301_NO2_R2>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 94px; display: block; left: 456px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;  top: 320px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_F_33301_O2_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 55px; display: block; left: 559px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;   top: 320px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_ASLLNL>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 41px; display: block;left: 619px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;     top: 320px;"></div>
<%--        <div class="AnlogSignal mchart" id="zc_nxjc_whsmc_whsmf>dcs01_F_33301_FC_R1>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block; left: 900px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px; bottom: 124px;"></div>--%>
        ...
        <%--喀喇沁公司--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_YTZX_FC_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 52px; display: block;left: 261px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;  top: 349px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZXJC_KL_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block;left: 325px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;  top: 349px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZXJC_SO2_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 65px; display: block; left: 385px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;  top: 349px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZXJC_NO_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 94px; display: block;left: 457px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;  top: 349px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZXJC_O2_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 55px; display: block; left: 559px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;  top: 349px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_TXLLFK_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 41px; display: block;left: 619px; position: absolute; color:black; text-align: center;font-size: 13px; height: 23px;     top: 349px;"></div>
    </div>
