...
<head id="Head1" runat="server">
    ...
    <script charset="utf-8">
        ...
        function InitConfig(myClass) {
            ...
            $('#startTime').datetimebox({
                onChange: function () {
                    ...
                    else if (Intmin > 60 && Intmin < 14400) {
                        var productJsonData = [{
                            "id": 1,
                            "text": "5分",
                            "value": 300,
                    ...
                    else if (Intmin > 14400 && Intmin < 43200) {
                        var productJsonData = [{
                            "id": 1,
                            "text": "2小时",
                            "value": 7200,
        ...
        function formatData(json) {
            ...
            DATA_POINT_PER_SCREEN = data.length;
            currentData = data.slice(1, data.length);
        ...
        function sliderChanged(value) {
            ...
            //value = (value * (data.length - DATA_POINT_PER_SCREEN) / 10);
            currentData = data.slice(1, DATA_POINT_PER_SCREEN * value / 100);
